...
func TestReturnStatements(t *testing.T) {
	...
	for _, stmt := range program.Statements {
		...
		if returnStmt.TokenLiteral() != "return" {
			t.Errorf("Expected token literal 'return', got %q", returnStmt.TokenLiteral())
		}
	}
}
...
func TestIdentifierExpression(t *testing.T) {
	...
	if ident.Value != "foobar" {
		t.Errorf("Expected ident.Value to be 'foobar', got %q", ident.Value)
	}
	if ident.TokenLiteral() != "foobar" {
		t.Errorf("Expected ident.TokenLiteral() to be 'foobar', got %q", ident.TokenLiteral())
	}
}
